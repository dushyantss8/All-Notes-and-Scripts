...
Narrow unknown values with `typeof`, `in`, discriminated unions, or user-defined predicates. Validate untrusted runtime input with a schema library; TypeScript types disappear at runtime.

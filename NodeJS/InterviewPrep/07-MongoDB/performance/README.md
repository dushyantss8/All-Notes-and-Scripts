...
Optimize from evidence: profile slow operations, use explain, reduce documents and fields examined, and avoid unbounded scans.


## Core APIs and concepts

- explain, executionStats, profiler, hint, projection, batchSize, maxTimeMS
...
- [ ] Diagnose a slow paginated search endpoint.

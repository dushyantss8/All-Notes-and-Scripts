...
Indexes trade write cost and storage for faster reads. Compound index field order must match real query shapes.


## Core APIs and concepts

- createIndex, explain, compound, partial, sparse, TTL, text, unique, covered query
...
- [ ] Design and validate indexes for an orders API.

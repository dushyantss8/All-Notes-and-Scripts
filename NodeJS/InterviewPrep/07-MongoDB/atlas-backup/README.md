...
Atlas adds managed deployment, monitoring, backup, network controls, and scaling; backup strategy must be tested through restores.


## Core APIs and concepts

- Atlas clusters, snapshots, PITR, mongodump, mongorestore, roles, IP access list
...
- [ ] Document a restore drill with recovery objectives.

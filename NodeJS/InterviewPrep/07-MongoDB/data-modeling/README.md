...
Model around access patterns, cardinality, growth, and atomicity. Embed bounded data read together; reference unbounded or independently managed entities.


## Core APIs and concepts

- embedding, references, denormalization, document size, schema versioning
...
- [ ] Model users, posts, comments, and likes.

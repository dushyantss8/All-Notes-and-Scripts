...
Multi-document transactions provide ACID guarantees but add coordination and retry requirements; prefer single-document atomic designs where possible.


## Core APIs and concepts

- startSession, withTransaction, readConcern, writeConcern, transient errors
...
- [ ] Transfer balance between two accounts safely.

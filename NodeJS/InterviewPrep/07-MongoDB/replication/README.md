...
A replica set replicates an oplog from a primary to secondaries and elects a new primary on failure.


## Core APIs and concepts

- rs.initiate, rs.status, readPreference, writeConcern, oplog, elections
...
- [ ] Explain a three-member replica-set failure scenario.

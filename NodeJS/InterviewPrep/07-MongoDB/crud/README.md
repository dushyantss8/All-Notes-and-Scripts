...
MongoDB documents are updated atomically at document scope. Filter precisely and inspect matched/modified counts.


## Core APIs and concepts

- insertOne, find, findOne, updateOne, $set, $inc, deleteOne, bulkWrite
...
2. **How do you avoid accidentally updating many documents?**  
...
- [ ] Write CRUD and upsert queries for an orders collection.

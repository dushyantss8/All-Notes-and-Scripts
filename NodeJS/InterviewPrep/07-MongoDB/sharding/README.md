...
Sharding partitions data across shards using a shard key. Good keys distribute writes and route common queries.


## Core APIs and concepts

- sh.shardCollection, shard key, mongos, chunks, balancer, zones, resharding
...
- [ ] Choose a shard key for multi-tenant time-series data.

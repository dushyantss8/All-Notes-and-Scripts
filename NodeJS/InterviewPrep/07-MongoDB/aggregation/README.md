...
Aggregation transforms document streams through ordered stages. Put selective $match early and inspect plans for expensive pipelines.


## Core APIs and concepts

- $match, $project, $group, $sort, $lookup, $unwind, $facet, $setWindowFields
...
- [ ] Build revenue, cohort, and top-products pipelines.

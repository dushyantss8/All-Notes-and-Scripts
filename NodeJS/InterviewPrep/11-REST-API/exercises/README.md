...
Implement cursor pagination, allow-listed filters, validation, centralized errors, owner checks, and upload limits.

## What to know

- **Done:** Test malformed IDs/tokens, cross-user mutation, duplicate requests, and oversized uploads.

...
Bound query input and choose a pagination strategy that matches data size and mutation rate.

## What to know

- **Cursor:** Cursor pagination uses stable sorted values plus ID and avoids offset drift.
- **Limits:** Set defaults and maximum page sizes to cap database and response cost.
- **Filters:** Allow-list fields/operators and build indexes for common combinations.

...
Mock external boundaries such as payment, email, clocks, and network clients—avoid mocking every internal detail.

## What to know

- **Choice:** Prefer explicit fakes for domain collaborators; use Jest mocks for focused boundary checks.
- **Confidence:** Retain integration tests against real implementations.

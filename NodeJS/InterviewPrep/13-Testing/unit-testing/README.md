...
Unit tests exercise a small behavior with collaborators supplied explicitly or replaced.

## What to know

- **Design:** Dependency injection makes services testable without network/database state.
- **Cases:** Cover happy path, boundaries, invalid input, and business-rule failures.

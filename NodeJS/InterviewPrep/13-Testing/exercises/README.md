...
Write a permission-service unit test, repository integration test, and protected route Supertest suite.

## What to know

- **Done:** Use controlled time, clean fixtures, random IDs, and no test-order dependence.

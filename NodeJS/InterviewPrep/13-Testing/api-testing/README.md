...
Supertest drives Express in-process. Export the app separately from its network listener.

## What to know

- **Contract:** Assert status, body, headers, errors, and authorization behavior.
- **Fixtures:** Seed only test-local data and never share mutable state across tests.

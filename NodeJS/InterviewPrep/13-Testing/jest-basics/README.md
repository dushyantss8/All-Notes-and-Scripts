...
Jest discovers tests, runs assertions, provides lifecycle hooks, and reports failures/coverage.

## What to know

- **Isolation:** Use `beforeEach` for fresh state and always await async expectations.
- **Assertions:** Use precise matchers so failures explain the contract.

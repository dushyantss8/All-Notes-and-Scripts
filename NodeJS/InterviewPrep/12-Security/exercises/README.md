...
Threat-model a task API, then add injection-safe filters, precise CORS, rate-limited login, secure cookies, and sanitized rich text.

## What to know

- **Done:** For every control, demonstrate the attack is blocked and name residual risk.

...
Use OWASP as a review checklist, not a substitute for threat modeling.

## What to know

- **Prioritize:** Fix broken access control and injection based on asset value, exposure, and exploitability.
- **Lifecycle:** Include dependency updates, review, testing, monitoring, and incident response.

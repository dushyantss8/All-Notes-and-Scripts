...
Mongoose middleware can alter queries or documents at framework boundaries; use explicit services for workflows requiring clarity and retries.


## Core APIs and concepts

- query middleware, document middleware, aggregate middleware, error middleware
...
- [ ] Add automatic tenant filtering to selected queries.

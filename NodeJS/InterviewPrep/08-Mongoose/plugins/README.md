...
Plugins package reusable schema behavior such as pagination, auditing, soft deletion, or field encryption; document their query semantics.


## Core APIs and concepts

- schema.plugin, mongoose.plugin, statics, methods, query helpers
...
- [ ] Create a tenant-scoping plugin.

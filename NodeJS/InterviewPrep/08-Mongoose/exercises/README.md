...
Practice schema boundaries, query behavior, validation, population, and transactional workflows.


## Core APIs and concepts

- schemas, middleware, sessions, tests
...
- [ ] Build a small models package and test it against MongoDB.

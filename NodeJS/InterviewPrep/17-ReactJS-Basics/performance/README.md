...
Profile before optimizing. Stabilize keys in lists, virtualize large collections, split heavy routes, avoid unnecessary context updates, and memoize only expensive work or components that actually re-render too often.

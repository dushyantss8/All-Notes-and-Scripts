...
Model loading, success, empty, and error states. Abort obsolete requests, prevent state updates after unmount, and include authentication/correlation headers. A query library can deduplicate, cache, invalidate, and retry server state.

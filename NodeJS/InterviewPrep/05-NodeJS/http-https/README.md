...
Node's HTTP modules expose low-level servers and clients. Correct timeouts, limits, streaming, and shutdown behavior are production requirements.


## Core APIs and concepts

- createServer, request, fetch, Agent, headers, statusCode, keepAliveTimeout, requestTimeout
...
- [ ] Build a JSON server with body limit, timeout, and graceful shutdown.

...
crypto provides secure randomness, hashing, HMAC, key derivation, encryption, and signatures. Prefer modern authenticated primitives and password KDFs.


## Core APIs and concepts

- randomBytes, randomUUID, createHash, createHmac, scrypt, pbkdf2, timingSafeEqual, createCipheriv
...
- [ ] Implement password hashing with scrypt and timing-safe verification.

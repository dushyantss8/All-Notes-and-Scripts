...
EventEmitter is Node's synchronous publish/subscribe primitive. Listener ordering, error handling, and leak prevention matter in services.


## Core APIs and concepts

- EventEmitter, on, once, emit, off, error, events.once, events.on, setMaxListeners
...
- [ ] Build an event-driven order workflow with once-only completion and error handling.

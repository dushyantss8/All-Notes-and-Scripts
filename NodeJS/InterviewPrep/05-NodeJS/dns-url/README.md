...
dns can use OS lookup or DNS protocol resolution; URL provides standards-based parsing and safe query manipulation.


## Core APIs and concepts

- dns.lookup, resolve, promises, URL, URLSearchParams, domainToASCII
...
- [ ] Build a URL allowlist validator and DNS lookup helper.

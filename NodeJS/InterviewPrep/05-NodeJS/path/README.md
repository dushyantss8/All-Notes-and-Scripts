...
path safely constructs and analyzes filesystem paths using platform conventions; it does not itself prove a path is authorized.


## Core APIs and concepts

- join, resolve, normalize, parse, format, basename, extname, relative, delimiter
...
- [ ] Safely map a user file name into an uploads directory.

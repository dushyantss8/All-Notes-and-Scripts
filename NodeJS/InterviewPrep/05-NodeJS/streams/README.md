...
Streams process data incrementally with bounded memory. Backpressure is the contract that keeps producers from outrunning consumers.


## Core APIs and concepts

- Readable, Writable, Duplex, Transform, pipeline, finished, highWaterMark, backpressure
...
- [ ] Stream a large CSV transform with pipeline and error cleanup.

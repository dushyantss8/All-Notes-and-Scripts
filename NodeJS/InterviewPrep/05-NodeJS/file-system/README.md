...
fs has callback, promise, and stream APIs. Use asynchronous APIs for server paths and write atomically when replacing important files.


## Core APIs and concepts

- fs/promises, readFile, writeFile, open, stat, rename, mkdir, watch, createReadStream
...
- [ ] Implement a JSON config store with validation and atomic writes.

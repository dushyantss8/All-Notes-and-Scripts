...
Refactor controller/service/repository, inject clock/repository fakes, publish an idempotent outbox event, and write a monolith-to-services decision record.

## What to know

- **Done:** State each boundary, dependency direction, and operational trade-off.

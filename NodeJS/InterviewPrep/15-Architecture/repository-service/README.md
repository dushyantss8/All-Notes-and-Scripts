...
Repositories hide persistence details; services coordinate use cases, policy, transactions, and side effects.

## What to know

- **Repository:** Expose domain-oriented operations, not scattered query syntax.
- **Service:** Enforce invariants and authorization before persistence.

...
Supply dependencies from a composition root instead of constructing hidden globals in business code.

## What to know

- **Value:** Tests can use fakes; production uses real databases, clocks, and clients.
- **Practice:** Prefer explicit function/constructor injection before a container.

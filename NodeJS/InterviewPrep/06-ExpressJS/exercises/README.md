...
Practice boundaries: routing, validation, errors, authentication, uploads, and operational middleware.


## Core APIs and concepts

- routers, middleware ordering, tests, security
...
- [ ] Build a small CRUD API with the listed production controls.

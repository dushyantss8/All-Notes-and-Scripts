...
Production REST APIs use consistent resource semantics, status codes, pagination, idempotency, conditional updates, and problem responses.


## Core APIs and concepts

- GET POST PATCH DELETE, ETag, If-Match, cursor pagination, idempotency key
...
- [ ] Implement cursor pagination and standardized error responses.

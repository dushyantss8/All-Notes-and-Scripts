...
CORS is a browser-enforced cross-origin policy expressed through response headers; it is not authentication or server-side access control.


## Core APIs and concepts

- cors, origin, methods, credentials, preflight, Access-Control-Allow-Origin
...
1. **Why cannot credentials be combined with wildcard origin?**  
...
- [ ] Configure an allowlist for browser clients.

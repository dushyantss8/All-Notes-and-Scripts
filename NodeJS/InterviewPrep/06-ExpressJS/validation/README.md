...
Validate untrusted path, query, body, and header data at the boundary. express-validator is middleware-oriented; Zod is schema-first.


## Core APIs and concepts

- express-validator, validationResult, z.object, safeParse, coercion
...
- [ ] Validate create-user input and return RFC-style field errors.

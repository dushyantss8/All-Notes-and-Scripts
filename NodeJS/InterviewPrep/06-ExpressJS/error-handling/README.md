...
Centralize operational error translation, avoid leaking internals, and let unexpected faults be logged and trigger controlled recovery.


## Core APIs and concepts

- next(err), error handler, headersSent, status, Error.cause
...
- [ ] Create typed API errors and a final error middleware.

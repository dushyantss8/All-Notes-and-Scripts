...
Express hardening combines secure defaults, input validation, authz, headers, TLS, dependency hygiene, and operational controls.


## Core APIs and concepts

- helmet, trust proxy, csrf strategy, body limits, parameterized queries, sanitize
...
- [ ] Harden a minimal API against common web attacks.

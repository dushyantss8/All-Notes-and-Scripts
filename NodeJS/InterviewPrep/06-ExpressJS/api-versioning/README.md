...
Version only when a breaking contract change needs coexistence. Prefer additive evolution and publish a deprecation policy.


## Core APIs and concepts

- URL versioning, media types, headers, deprecation, Sunset
...
1. **Where can an API version be carried and what are the trade-offs?**  
   Start with the invariant or runtime behavior, then state the trade-off and a concrete operational example.
2. **How do you deprecate an endpoint safely?**  
...
- [ ] Serve v1 and v2 with contract tests.

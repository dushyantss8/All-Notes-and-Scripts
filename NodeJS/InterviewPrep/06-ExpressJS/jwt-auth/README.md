...
JWTs are signed claims, not encrypted secrets. Verify issuer, audience, algorithm, expiry, and revocation strategy.


## Core APIs and concepts

- jsonwebtoken, sign, verify, exp, aud, iss, Authorization Bearer
...
- [ ] Implement rotating refresh tokens and protected routes.

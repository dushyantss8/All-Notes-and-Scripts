...
Use structured application logs with request IDs and redact secrets. Morgan covers access logs; Winston/Pino handle application logs.


## Core APIs and concepts

- morgan, winston, logger.child, requestId, redaction
...
- [ ] Add JSON request and error logs with correlation IDs.

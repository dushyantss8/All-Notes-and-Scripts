...
multer parses multipart/form-data. Enforce size/type limits, avoid trusting filenames, and move files to durable storage deliberately.


## Core APIs and concepts

- multer, diskStorage, memoryStorage, limits, fileFilter, req.file
...
- [ ] Upload a file with limits, virus-scan hook, and metadata persistence.

...
Optimize using actual plans and measured latency: reduce scanned rows, choose selective indexes, keep statistics current, and avoid premature hints.


## Core APIs and concepts

- EXPLAIN, EXPLAIN ANALYZE, seq scan, index scan, join algorithms, statistics, pagination
...
- [ ] Diagnose an intentionally slow reporting query.

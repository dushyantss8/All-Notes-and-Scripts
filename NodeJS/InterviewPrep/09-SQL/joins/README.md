...
Joins combine related rows. The join type determines whether unmatched rows survive; cardinality determines whether results multiply.
...
- [ ] Write customer-order and employee-manager joins.

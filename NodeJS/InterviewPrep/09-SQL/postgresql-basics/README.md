...
PostgreSQL is a feature-rich relational database with strong transactional semantics, extensible types, and excellent planning tools.


## Core APIs and concepts

- SERIAL/IDENTITY, RETURNING, JSONB, EXPLAIN ANALYZE, VACUUM, CTE
...
- [ ] Create a table and use INSERT ... RETURNING.

...
Constraints preserve correctness; indexes accelerate access. Model both deliberately and understand their write costs.


## Core APIs and concepts

- PRIMARY KEY, FOREIGN KEY, UNIQUE, CHECK, NOT NULL, CREATE INDEX, composite index
...
1. **Why is a foreign key not an index in every database?**  
...
- [ ] Add constraints and indexes for order queries.

...
MySQL is a relational database commonly used with InnoDB. Know SQL semantics and MySQL-specific operational details.


## Core APIs and concepts

- CREATE TABLE, AUTO_INCREMENT, EXPLAIN, InnoDB, LIMIT, transaction isolation
...
- [ ] Create a users table and query it safely.

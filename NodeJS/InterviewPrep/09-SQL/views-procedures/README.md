...
Views encapsulate queries; functions and procedures can centralize database-side logic, but keep ownership and versioning clear.


## Core APIs and concepts

- CREATE VIEW, materialized view, CREATE FUNCTION, procedure, trigger
...
- [ ] Create a reporting view and refresh strategy.

...
Use parameterized statements and transactions where a logical operation spans statements. Never interpolate untrusted values into SQL.


## Core APIs and concepts

- INSERT, SELECT, UPDATE, DELETE, RETURNING, UPSERT, prepared statements
...
- [ ] Write CRUD for products with safe parameters.

...
Normalization reduces update anomalies by separating independent facts; selective denormalization can improve read performance when managed carefully.


## Core APIs and concepts

- 1NF, 2NF, 3NF, BCNF, functional dependency, denormalization
...
1. **What anomaly does normalization prevent?**  
...
- [ ] Normalize a sales spreadsheet into tables.

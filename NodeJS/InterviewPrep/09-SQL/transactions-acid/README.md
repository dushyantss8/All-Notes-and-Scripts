...
Transactions group operations atomically. Isolation choices balance anomalies against contention and must be understood per database.


## Core APIs and concepts

- BEGIN, COMMIT, ROLLBACK, SAVEPOINT, isolation, locks, MVCC, deadlock
...
- [ ] Transfer money with row locks and retry handling.

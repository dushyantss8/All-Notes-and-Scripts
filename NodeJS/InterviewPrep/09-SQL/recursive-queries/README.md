...
Recursive CTEs traverse hierarchies and graphs using an anchor query plus recursive member; add cycle protection and depth limits.


## Core APIs and concepts

- WITH RECURSIVE, anchor, UNION ALL, path, depth, cycle
...
- [ ] Return an organization subtree with depth.

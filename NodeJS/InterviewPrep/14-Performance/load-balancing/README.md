...
Load balancers distribute requests to healthy instances and often terminate TLS.

## What to know

- **Health:** Expose readiness/liveness and drain connections before shutdown.
- **State:** Use shared/portable state; sticky sessions are not a resilient storage strategy.

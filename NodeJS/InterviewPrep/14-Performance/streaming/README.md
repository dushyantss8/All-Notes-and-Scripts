...
Streams process data incrementally with bounded memory. Respect backpressure.

## What to know

- **Pipeline:** Use `stream.pipeline()` to propagate errors and close resources.
- **Use:** Files, compression, CSV import/export, and proxying are common stream workloads.
